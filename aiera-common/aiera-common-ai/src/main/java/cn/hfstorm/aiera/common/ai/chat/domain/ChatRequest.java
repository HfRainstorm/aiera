package cn.hfstorm.aiera.common.ai.chat.domain;
...
public class ChatRequest {
    ...
    public record ChatCompletionRequest(@JsonProperty("chat_id") String chatId,
                                        @JsonProperty("aigc_model_id") String aigcModelId,
                                        @JsonProperty("conversation_id") String conversationId,
                                        @JsonProperty("aigc_knowledge_id") List<String> aigcKnowledgeIds,
         ...
         * @param aigcModelId      ID of the modelName to use.
         * @param aigcKnowledgeIds ID of the knowledge to use.
         * @param modelName        modelName to use.
         * @param messages         A list of messages comprising the conversation so far.
         * @param temperature      What sampling temperature to use, between 0 and 1.
         */
        public ChatCompletionRequest(String requestId, String aigcModelId, String conversationId,
                                     List<String> aigcKnowledgeIds, String modelName,
                                     List<ChatCompletionMessage> messages,
                                     Double temperature) {
            this(requestId, aigcModelId, conversationId, aigcKnowledgeIds, modelName, messages, null, null,
        ...
        public ChatCompletionRequest(String requestId, String aigcModelId, String conversationId,
            ...
            this(requestId, aigcModelId, conversationId, aigcKnowledgeIds, modelName, messages, null, stream,
                    temperature, null, null, null, null, null, null);
        }
        ...
        public ChatCompletionRequest(String requestId, String aigcModelId, String conversationId,
            ...
            this(requestId, aigcModelId, conversationId, aigcKnowledgeIds, modelName, messages, null, false, 0.95d,
                    null, null, null, tools, toolChoice, null);
        }
         ...
         * @param requestId A unique identifier for the request.
         * @param messages  A list of messages comprising the conversation so far.
         * @param stream    If set, partial message deltas will be sent.Tokens will be sent as data-only server-sent
         *                  events
         *                  as they become available, with the stream terminated by a data: [DONE] message.
         */
        public ChatCompletionRequest(String requestId, List<ChatCompletionMessage> messages, Boolean stream) {
            this(requestId, null, IdUtil.simpleUUID(), null, null, messages, null, stream, null, null, null, null, null, null, null);
        }
     ...
     */
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public record EmbeddingResponseData(@JsonProperty("index") Integer index, @JsonProperty("object") String object,
     ...
     */
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public record EmbeddingResponseUsage(@JsonProperty("prompt_tokens") Integer promptTokens,
                                         @JsonProperty("completion_tokens") Integer completionTokens,
                                         @JsonProperty("total_tokens") Integer totalTokens) {
    }
