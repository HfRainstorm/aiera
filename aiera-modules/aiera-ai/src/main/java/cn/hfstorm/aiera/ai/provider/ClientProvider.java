...
//        MessageChatMemoryAdvisor messageChatMemoryAdvisor = new MessageChatMemoryAdvisor(chatMemory, conversionId,
//                chatConfig.getChatHistoryWindowSize());
//
//        return ChatClient.builder(model).defaultAdvisors(messageChatMemoryAdvisor
